...
from baxus_cma.benchmarks.synthetic_benchmark_functions import (
...
from baxus_cma.util.acquisition_function_types import AcquisitionFunctionType
from baxus_cma.util.behaviors.gp_configuration import MLLEstimation
from baxus_cma.util.behaviors.embedding_configuration import EmbeddingType
...
def benchmark_loader(bench: str, args: Namespace):
    ...
    if bench == "lasso-leukemia":
        from baxus_cma.benchmarks.real_world_benchmarks import LassoLeukemiaBenchmark

        _fun_mapper[bench] = LassoLeukemiaBenchmark

    if bench == "lasso-breastcancer":
        from baxus_cma.benchmarks.real_world_benchmarks import LassoBreastCancerBenchmark

        _fun_mapper[bench] = LassoBreastCancerBenchmark

    if bench == "lasso-dna":
        from baxus_cma.benchmarks.real_world_benchmarks import LassoDNABenchmark

        _fun_mapper[bench] = LassoDNABenchmark

    if bench == "lasso-diabetes":
        from baxus_cma.benchmarks.real_world_benchmarks import LassoDiabetesBenchmark

        _fun_mapper[bench] = LassoDiabetesBenchmark

    if bench == "lasso-rcv1":
        from baxus_cma.benchmarks.real_world_benchmarks import LassoRCV1Benchmark

        _fun_mapper[bench] = LassoRCV1Benchmark
    if bench == "lasso-simple":
        from baxus_cma.benchmarks.real_world_benchmarks import LassoSimpleBenchmark

        _fun_mapper[bench] = LassoSimpleBenchmark
    if bench == "lasso-medium":
        from baxus_cma.benchmarks.real_world_benchmarks import LassoMediumBenchmark

        _fun_mapper[bench] = LassoMediumBenchmark
    if bench == "lasso-high":
        from baxus_cma.benchmarks.real_world_benchmarks import LassoHighBenchmark

        _fun_mapper[bench] = LassoHighBenchmark
    if bench == "lasso-hard":
        from baxus_cma.benchmarks.real_world_benchmarks import LassoHardBenchmark

        _fun_mapper[bench] = LassoHardBenchmark

    if bench == "mopta08":
        from baxus_cma.benchmarks.real_world_benchmarks import MoptaSoftConstraints

        _fun_mapper[bench] = MoptaSoftConstraints

    if bench == "svm":
        from baxus_cma.benchmarks.real_world_benchmarks import SVMBenchmark
