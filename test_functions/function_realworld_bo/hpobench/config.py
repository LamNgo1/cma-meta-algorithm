...
from test_functions.function_realworld_bo.hpobench import __version__
...
class HPOBenchConfig:
    ...
    def __init__(self):
        ...
        self.container_dir = self.cache_dir / f'hpobench-{"NA"}' # Replace os.getuid() by NA as we run the code on Windows
